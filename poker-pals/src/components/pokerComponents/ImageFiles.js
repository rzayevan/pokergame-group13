module.exports =  {
    imageFiles: [ // each image resource is loaded into an array and elements can request them by either index or name
        ...
        {src: require(`../../images/player_icon_1.png`), name: 'player_icon'},

        {src: require(`../../images/icons/camel.png`), name: 'player_icon_1'},
        {src: require(`../../images/icons/cat.png`), name: 'player_icon_2'},
        {src: require(`../../images/icons/cow.png`), name: 'player_icon_3'},
        {src: require(`../../images/icons/crocodile.png`), name: 'player_icon_4'},
        {src: require(`../../images/icons/deer.png`), name: 'player_icon_5'},
        {src: require(`../../images/icons/dog.png`), name: 'player_icon_6'},
        {src: require(`../../images/icons/elephant.png`), name: 'player_icon_7'},
        {src: require(`../../images/icons/giraffe.png`), name: 'player_icon_8'},
        {src: require(`../../images/icons/goat.png`), name: 'player_icon_9'},
        {src: require(`../../images/icons/hippo.png`), name: 'player_icon_10'},
        {src: require(`../../images/icons/horse.png`), name: 'player_icon_11'},
        {src: require(`../../images/icons/kangaroo.png`), name: 'player_icon_12'},
        {src: require(`../../images/icons/lion.png`), name: 'player_icon_13'},
        {src: require(`../../images/icons/pig.png`), name: 'player_icon_14'},
        {src: require(`../../images/icons/sheep.png`), name: 'player_icon_15'},
        {src: require(`../../images/icons/zebra.png`), name: 'player_icon_16'},
